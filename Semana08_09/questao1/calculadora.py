...
class Window(QMainWindow):
    ...
    def UiComponents(self):
        ...
        # Criação dos botoes e posicionando-os na tela
        ...
        # Adicionando rotina de ação de cada botao
